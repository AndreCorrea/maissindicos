<?php
// REMOVE A BARRA FIXA DO PAIEL NO FRONTEND
...
// Inicia as configuções do function.php
...
function crunchify_social_sharing_buttons($content) {
    ...
    if(is_single()){
        ...
        $content .= '<div class="crunchify-social" id="crunchify-social">';
        $content .= '<ul class="list-unstyled">';
        $content .= '<li><a class="crunchify-link crunchify-twitter" href="'. $twitterURL .'" target="_blank"><i class="icon-twitter"></i></a></li>';
        $content .= '<li><a class="crunchify-link crunchify-facebook" href="'.$facebookURL.'" target="_blank"><i class="icon-facebook"></i></a></li>';
        $content .= '<li><a class="crunchify-link crunchify-googleplus" href="'.$googleURL.'" target="_blank"><i class="icon-google-plus"></i></a></li>';
        $content .= '<li><a class="crunchify-link crunchify-linkedin" href="'.$linkedInURL.'" target="_blank"><i class="icon-linkedin"></i></a></li>';
        $content .= '</ul>';
        $content .= '</div>';
